...
class TheatersMapViewController: UIViewController {
    ...
    func getRoute(destination: CLLocationCoordinate2D) {
        ...
        request.destination = MKMapItem(placemark: MKPlacemark(coordinate: destination)) // map item pra onde eu quero ir
        ...
        directions.calculate { (response: MKDirectionsResponse?, error: Error?) in
            ...
            if error == nil {
                ...
                //linha poligonal que representa a rota
                //linha que recebe a rota
                //ja pega a rota, que fica acima do mapa e abaixo dos labels
...
extension TheatersMapViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        if control == view.leftCalloutAccessoryView {
            ...
            //quando ele pedir a rota, peco para o mapview remover os overlays do map view
...
extension TheatersMapViewController: UISearchBarDelegate {
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        //estamos solicitando uma busca local(nos servidores da apple)
        ...
        search.start{ (response: MKLocalSearchResponse?, error: Error?) in
            ...
            if error == nil {
                ...
                //objeto que tem as informacoes do lugar que vc pesquisou
